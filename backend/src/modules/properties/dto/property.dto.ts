...
export class CreatePropertyDto {
  ...
  @ApiProperty({ example: 'Luxury 2BR Apartment - Downtown Dubai' })
  @IsString()
  @MaxLength(500)
  title: string;
  @ApiPropertyOptional() @IsOptional() @IsString() description?: string;
  @ApiProperty({ example: 'Sheikh Mohammed Bin Rashid Blvd' })
  @IsString()
  @MaxLength(500)
  location: string;
...
export class AddImageDto {
  @ApiProperty({ example: 'https://storage.proptrack.com/img/1.jpg' })
  @IsString()
  imageUrl: string;
