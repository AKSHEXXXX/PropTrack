...
export class CreateAppointmentDto {
  ...
  @ApiProperty({ example: '2025-08-15T10:00:00Z' }) @IsDateString() scheduledAt: string;
  @ApiProperty({ enum: AppointmentType, example: AppointmentType.SITE_VISIT }) @IsEnum(AppointmentType) type: AppointmentType;
