...
export class CreatePaymentDto {
  ...
  @ApiPropertyOptional({ example: '2025-09-01' }) @IsOptional() @IsDateString() paymentDate?: string;
  @ApiPropertyOptional({ example: 'TXN-2025-0901-001' }) @IsOptional() @IsString() referenceNo?: string;
}
